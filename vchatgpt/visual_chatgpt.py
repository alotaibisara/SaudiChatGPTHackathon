...
class ImageCaptioning:
    ...
    @prompts(name="Get Photo Description",
                     description=""""Prompt: As a plant disease identification expert, your task is to identify the diseases present in the following images of plants. You should only provide hints to the plant owners about the type of disease present in the plant based on the visual symptoms shown in the image. Your hints should be concise and clear, but without giving away the exact disease name.  image_path. """)
